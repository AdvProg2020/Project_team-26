...
public interface IAuthenticationController {
    ...
    void login(String username, String password, String token) throws PasswordIsWrongException,InvalidTokenException, InvalidFormatException, AuthenticationException, InvalidAuthenticationException;
