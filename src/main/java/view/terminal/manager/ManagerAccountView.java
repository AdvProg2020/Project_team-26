...
import view.terminal.UserView;
import view.terminal.View;
import view.terminal.ViewManager;
import view.terminal.manager.category.ManageCategoryForManagerView;
import view.terminal.manager.Promo.PromoForManagerView;
import view.terminal.manager.request.ManageRequestForManagerView;
import view.terminal.manager.users.ManageUsersForManager;
